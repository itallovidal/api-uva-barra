## Purpose
This specification covers the search functionality for news articles, including text search, ordering, and pagination. Search results are served from in-memory cache; detail retrieval by id or slug fetches from Firebase Firestore.
